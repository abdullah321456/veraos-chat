...
export function PlanLimit({ isEditable }: PlanLimitProps) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="shadow-lg p-4 border border-gray-50 rounded-[10px] w-full sm:w-[346px] hidden">
...
function PaymentType({ isEditable }: PaymentTypeProps) {
  ...
  return (
    <div className="shadow-lg p-4 border border-gray-50 rounded-[10px] w-full sm:w-[346px] space-y-6 hidden">
