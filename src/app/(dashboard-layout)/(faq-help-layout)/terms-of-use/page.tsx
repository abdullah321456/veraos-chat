...
export default function TermsOfUsePage() {
  return (
    <div className="w-[800px] mx-auto">
      <FadeAnimation>
        <h1 className="text-black text-[24px] font-bold text-center my-8">
        ...
        <div className="space-y-8">
          {/* Introduction */}
          <section>
            <h2 className="text-black text-lg font-bold mb-4">Introduction</h2>
          ...
          <section>
            <h2 className="text-black text-lg font-bold mb-4">Acceptable Use Cases</h2>
          ...
          {/* Prohibited Uses */}
          <section>
            <h2 className="text-black text-lg font-bold mb-4">Prohibited Uses</h2>
            <div className="space-y-3">
          ...
          {/* Legal Compliance */}
          <section>
            <h2 className="text-black text-lg font-bold mb-4">Legal Compliance</h2>
            <div className="space-y-3">
              <p className="text-black text-sm leading-relaxed">
          ...
          {/* Data Protection */}
          <section>
            <h2 className="text-black text-lg font-bold mb-4">Data Protection & Privacy</h2>
            <div className="space-y-3">
              <p className="text-black text-sm leading-relaxed">
          ...
          {/* Consequences */}
          <section>
            <h2 className="text-black text-lg font-bold mb-4">Consequences of Violation</h2>
            <div className="space-y-3">
              <p className="text-black text-sm leading-relaxed">
          ...
          {/* Contact Information */}
          <section>
            <h2 className="text-black text-lg font-bold mb-4">Contact Information</h2>
